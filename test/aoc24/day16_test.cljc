...
(t/deftest part1
  (t/testing "input" (t/is (= (day16/part1 "./assets/day16/input.txt") 107512)))
  (t/testing "example" (t/is (= (day16/part1 "./assets/day16/example.txt") 7036)))
  (t/testing "example" (t/is (= (day16/part1 "./assets/day16/example2.txt") 11048))))
